...
x-skills-master:
  ...
  platforms: ["android"]
  requires: { "android": "4.1", "kotlin": "2.2", "games-controller": "2.0.2" }
  pairs_with: [agdk-game-activity]
  sources:
    - https://developer.android.com/games/sdk/game-controller/overview
    - https://developer.android.com/games/sdk/game-controller/controller-input
    - https://developer.android.com/games/sdk/game-controller/controller-features
