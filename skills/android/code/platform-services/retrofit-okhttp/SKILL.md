...
description: "Use when building or reviewing an Android network layer with Retrofit and OkHttp: service interfaces, suspend functions and Flow, kotlinx.serialization or Moshi converters, interceptors and auth headers, timeouts, caching, and HTTP error handling."
license: MIT
globs:
  - "**/*.kt"
tags: [coroutines]
x-skills-master:
  ...
  pairs_with: [choosing-http-client, networking-data-layer]
  sources:
...
- **Worked examples:** [examples.md](examples.md) — read when you want working Retrofit and OkHttp code to adapt
- **Review checklist:** [checklist.md](checklist.md) — run before merging changes to Retrofit and OkHttp
