...
description: "Use when designing or reviewing a loading state, background operation or in-progress feedback: linear versus circular, determinate versus indeterminate, the M3 Expressive loading indicator, and when to show no indicator at all. M3 design critique, not code."
license: MIT
tags: []
x-skills-master:
  domain: android
  ...
  pairs_with: [m3-loading-indicator, m3-loading]
  sources:
...
- **Worked examples:** [examples.md](examples.md) — read for worked progress indicators scenarios to compare a design against
- **Review checklist:** [checklist.md](checklist.md) — run before a design review of progress indicators
