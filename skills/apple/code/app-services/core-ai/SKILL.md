...
globs:
  - "**/*.swift"
tags: [core-ai, machine-learning, on-device, apple-silicon, inference]
x-skills-master:
  domain: apple
  class: code
  ...
  requires:
    ios: "27"
    swift: "6.0"
  pairs_with: [choosing-ml-approach, core-ml, foundation-models]
  sources:
    - https://developer.apple.com/documentation/CoreAI
    - https://developer.apple.com/documentation/coreai/aimodel
    - https://developer.apple.com/documentation/coreai/inferencefunction
