...
- **Worked examples:** [examples.md](examples.md) — read when you want working App Intents code to adapt
- **Review checklist:** [checklist.md](checklist.md) — run before merging changes to App Intents
