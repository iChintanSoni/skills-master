...
globs:
  - "**/*.swift"
tags: [visionos, swiftui, immersive-space, arkit, spatial-input, privacy]
x-skills-master:
  domain: apple
  class: code
  ...
  requires:
    visionos: "1"
    swift: "6.0"
  pairs_with: [visionos-windows-volumes, realitykit]
  sources:
    ...
    - https://developer.apple.com/documentation/visionos/adopting-best-practices-for-privacy
