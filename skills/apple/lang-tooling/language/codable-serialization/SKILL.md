...
globs:
  - "**/*.swift"
tags: [codable, json, decoding, serialization, foundation]
x-skills-master:
  domain: apple
  class: lang-tooling
  category: language
  ...
  requires:
    swift: "6.0"
  pairs_with: [networking-layer]
  sources:
    - https://developer.apple.com/documentation/foundation/encoding-and-decoding-custom-types
    - https://developer.apple.com/documentation/swift/codable
    - https://developer.apple.com/documentation/foundation/jsondecoder/keydecodingstrategy-swift.enum
