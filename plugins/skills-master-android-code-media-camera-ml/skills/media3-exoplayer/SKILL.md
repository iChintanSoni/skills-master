...
- **Worked examples:** [examples.md](examples.md) — read when you want working Media3 and ExoPlayer code to adapt
- **Review checklist:** [checklist.md](checklist.md) — run before merging changes to Media3 and ExoPlayer
